...
// Mobile-only experience. Starts as a copy of the desktop layout; art-direct
// this freely without touching the desktop view. Toggled via .view-mobile CSS.
        ...
        <section className="hero">
          <div className="wrap">
            <div className="copy">
              ...
              <p className="sub">
                An AI that answers in seconds <br />&amp; books the visit.
              </p>
              <div className="trust">
                <span className="dot" />
                <b>~4s replies</b>
